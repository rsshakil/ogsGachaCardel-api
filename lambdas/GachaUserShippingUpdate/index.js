    ...
    try {
        ...
        if (userShippingName != null && userShippingZipcode != null && userShippingAddress != null && userShippingTel != null) {
            ...
            if (userShippingPriorityFlag) {
                ...
                await mysql_con.query(userAddressUpdateSql, [0, userId]);
            }
            //updateUserShipping
            const updateUserSql = `
                UPDATE UserShipping SET 
                    userShippingName = ?,
                    userShippingZipcode = ?,
                    userShippingAddress = ?,
                    userShippingAddress2 = ?,
                ...
                where userShippingId = ? and userShippingUserId = ?;
            `;
            ...
            console.log("xxx4");
            const [query_reqult] = await mysql_con.query(updateUserSql, sql_param);
